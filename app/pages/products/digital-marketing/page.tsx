...
export default function AIDevelopementServices() {
  ...
  return (
    <div>
      ...
      \
      <div className="bg-blue-800 flex items-center w-8/12 h-[30vh] mx-auto text-white p-5">
        {/* LEFT — IMAGE */}
        <div className="w-1/3 flex justify-center items-center">
          <img
            src="/favicon.png"
            alt="image"
            className="w-1/3 h-1/2 object-cover rounded-md -rotate-45"
          />
        </div>
      ...
      <div className="w-8/12 mx-auto">
        ...
        <div className="max-w-6xl mx-auto w-full py-16 my-10 px-16 text-white flex bg-blue-950 font-pt">
          ...
          <div className="w-1/2 flex justify-center">
            <img src="/real1.png" alt="book" className="px-5 w-full h-[45vh]" />
          </div>
        </div>
      </div>
      <FadeSlideIn>
