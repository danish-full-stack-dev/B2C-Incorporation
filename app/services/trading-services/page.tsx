        ...
        <div className="flex py-16 h-5/6 mt-28">
          <div className="flex flex-col w-1/2 h-3/4 gap-3 ">
            ...
            <p className="text-2xl py-8 w-4/5 font-normal">
              Are you a clinic, laboratory, or independent practice association
              (IPA) tired of chasing down payments from patients and health
              insurance companies? Are slow billing processes, inaccurate coding
              and scrubbing, and repeated claim rejections and denials draining
              your time and budget? B2CINC is here to help. We build tailored
              revenue cycle management (RCM) software that effectively manages
              your financial operations and performance, freeing you to focus on
              what truly matters—delivering excellent patient care.
            </p>
