                  ...
                  <div className="flex flex-col h-3/5 w-4/5 justify-start">
                    <div className="w-full lg:w-3/5">
                      <div className="flex justify-between group">
                        <h3 className="text-2xl lg:text-3xl font-bold font-pt mb-6 hover:text-blue-800 hover:cursor-pointer">
                          {service.title}
                        </h3>
                        <ArrowUpRight className="w-6 h-6 lg:w-7 lg:h-7 group-hover:text-blue-800 group-hover:cursor-pointer group-hover:translate-x-1 group-hover:-translate-y-1 transition" />
                      </div>
                      ...
                      <div className="flex flex-col list-inside mt-5">
                        {service.services.map((item, idx) => (
                          <li
                            key={idx}
                            className="px-4 py-2 rounded-full text-sm lg:text-lg hover:text-blue-800 mr-2 bg-blend-color-dodge hover:translate-x-1 transition"
                          >
                            {item}
                          </li>
                        ))}
