...
export const ORMPageNavbar: React.FC = () => {
  ...
  return (
    <div className="flex fixed w-full z-30 justify-center text-blue-800">
      <div
      ...
      >
        <div
          className="w-full h-screen bg-white/70 flex flex-col"
        ...
        >
          ...
          <div className="h-2/3">
            <div className="md:hidden w-full h-full my-auto flex flex-col text-2xl text-blue-700 gap-4 justify-center items-center font-extrabold">
              <Link href={"/"}>reputation IQ</Link>
              <Link href={"/"}>insights</Link>
              <Link href={"/"}>listings</Link>
              <Link href={"/"}>serveys</Link>
      ...
      <div
        className={`flex flex-col w-full transition-all duration-500 shadow-sm
          ${
            hideNav
        ...
        `}
      >
        <div className="p-2 flex md:w-10/12 mx-auto my-2 items-center justify-between w-full md:px-0 px-5">
          ...
          <div className="md:flex justify-center hidden">
            <div className="flex gap-6">
              {[
                { heading: "reputation IQ", to: "/design/pages/our-services" },
                { heading: "insights", to: "/design/pages/our-works" },
                { heading: "listings", to: "/design/pages/about-us" },
                { heading: "reviews", to: "/design/pages/contact" },
                { heading: "serveys", to: "/design/pages/contact" },
                { heading: "social", to: "/design/pages/contact" },
                { heading: "actions", to: "/design/pages/contact" },
              ].map((value, idx) => (
                <Link
                  href={value.to}
                  key={idx}
                  className="hover:text-white transition hover:cursor-pointer font-bold"
                >
                  {value.heading}
                </Link>
              ))}
          ...
          <div className="md:hidden flex">
            <Link
              href={"/pages/contact"}
              className={`text-blue-700 font-extrabold transition-all duration-500`}
              // onClick={() => setOpen(true)}
            >
          ...
          <div className="md:flex hidden justify-center">
            <Link
              href={"/pages/contact"}
              className={`px-5 py-2 bg-transparent outline outline-1 rounded-full transition-all duration-500 hover:bg-blue-800 hover:text-white
