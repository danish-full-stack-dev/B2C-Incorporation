      ...
      <div className="w-8/12 mx-auto min-h-screen flex flex-col items-center">
        <div className="flex py-16 h-5/6 mt-28">
          <div className="flex flex-col w-1/2 h-3/4 gap-3 ">
            <h2 className="text-5xl font-medium font-bold">
              Online Reputation Management System(ORM's)
            </h2>
            <p className="text-2xl py-8 w-4/5 font-normal">
              Negative reviews, inconsistent online presence, and unmanaged
              client feedback can damage your real estate brand, reduce trust,
              and cost you qualified buyers and tenants. In a highly competitive
              property market, even a few unresolved complaints can influence
              purchasing and leasing decisions.
              <br />
              <br />
              We help real estate businesses protect and strengthen their brand
              with Online Reputation Management (ORM) solutions. Our services
              include review monitoring, reputation repair, response management,
              and brand sentiment analysis across property listing platforms,
              search engines, and social media. By proactively managing your
              online image, we help you build credibility, attract high-intent
              clients, and maintain a strong, trustworthy presence in the real
              estate market.
            </p>
        ...
        >
          <div className="flex flex-col w-1/2 h-3/4 gap-3 text-white ml-7 mb-10">
            <h2 className="text-3xl font-large mt-10 text-bold">
              Clutch Proven
            </h2>
            <p className="text-lg">
              Our extensive healthcare experience, empathy with clients, and
              ability to tackle complex medical projects have earned us the
              prestigious Top Software Developers Medical and Top IT Services
              Company Medical designations by Cluctch
            </p>
          </div>
      ...
      <div className="flex flex-col md:flex-row bg-[#001437] text-white rounded-xl overflow-hidden max-h-[300px] mx-[300px]">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <p className="text-lg leading-relaxed mb-6">
            “Revenue cycle management is a complex process with many nuances.
            With a deep understanding of the healthcare domain and proven
            expertise in cutting-edge technology and software implementation,
            B2CINC strives to bring maximum value to its clients. We lift the
            technological burden, allowing our clients to focus on the business
            side.”
          </p>
      ...
      <div className="w-8/12 mx-auto">
        ...
        <FadeSlideIn className="py-10">
          <div className="flex flex-col gap-3 py-10">
            ...
            <h2 className="text-4xl font-large text-bold">
              Benefits of revenue cycle management software
            </h2>
            <h6 className="mt-5 text-black-500">
              Whether you need to build custom RCM solutions or improve existing
              software, B2CINC<br></br>
              has you covered. We will help you:
            </h6>
          </div>
        ...
        <div className="w-full bg-[#001437] text-white py-20">
          <div className="w-full mx-auto px-6 md:px-16">
            ...
            {steps.map((step, index) => (
              <div
                key={index}
                className="flex gap-6 mb-14 group cursor-pointer"
              >
                {/* Auto Number */}
                <div className="flex flex-col items-center">
                  <div
                    className="w-10 h-10 flex items-center justify-center rounded-full border border-blue-500
        ...
        <div className="w-full mx-auto">
          <section className="pt-10">
            <div className="flex flex-col gap-3 py-10">
              ...
              <h2 className="text-4xl font-medium">
                We build RCM software for various healthcare<br></br>entities
              </h2>
            </div>
            <FadeSlideIn className="grid grid-cols-3 gap-6 items-center">
              {Processes.map((v, idx) => (
