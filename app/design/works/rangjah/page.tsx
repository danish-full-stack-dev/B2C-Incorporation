  ...
  const stages = [
    {
      ...
      title: "Brand Strategy & UX Research",
      hours: "2 days (Discovery Phase)",
      tags: [
        "Market Research",
        "Competitor Analysis",
        "UX Audit Report",
    ...
    },
    {
      ...
      highlightTag: "Developer Handoff Package",
    },
    {
      icon: <Loader className="w-6 h-6" />,
      title: "Development & CX Strategy",
      hours: "1 day (Deployment & QA)",
      tags: [
        "Usability Testing",
  ...
  return (
    <div className="bg-black/90">
      ...
      <div className="mx-auto w-10/12 pt-10">
        ...
        <FadeSlideIn className="bg-black text-white/80 my-10">
