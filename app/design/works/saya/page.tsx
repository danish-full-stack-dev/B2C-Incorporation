  ...
  return (
    <div className="bg-black/90">
      <div className="bg-black">
        <div className="min-h-screen mx-auto flex flex-col w-10/12 pt-32 gap-1 px-5">
          ...
          <div className="w-1/2 mx-auto my-40">
            <ZoomImage source="/sayaCaseStudy.png" />
          </div>
        </div>
      </div>
      <div className="mx-auto w-10/12 pt-10">
          ...
          <div className="flex justify-between gap-20">
            <div className="w-4/6">
              ...
              <p className="text-xl leading-7">
                It establishes Saya's unique positioning as a South African,
                slow-fashion brand that prioritizes local craftsmanship and
                ethical production methods. This foundation is crucial for
                analyzing specific business strategies, such as how the brand
                leverages its "made-in-Cape Town" identity to differentiate
                itself in a globally competitive market.
              </p>
            </div>
            ...
            <div className="h-3/5 my-auto flex ">
              ...
              <div className="w-3/4 flex justify-center">
                <h4 className="text-4xl w-4/5">
                  {" "}
                  Saya overcame the intense challenge of scaling a slow-fashion
                  business in a fast-fashion world, maintaining our commitment
                  to handmade quality while achieving sustainable growth. We are
                  proud that our brand has proven an ethical, locally-made model
                  can thrive in a highly competitive global market.
                </h4>
              </div>
            </div>
          </div>
        ...
        <FadeSlideIn className="w-full flex flex-row">
          <div className="w-1/3">
            <img
              src="/saya8.jpg"
              alt="saya image"
