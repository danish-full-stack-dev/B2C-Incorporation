...
//   title: "B2C Design",
//   description: "We Provide an Interective and eye catching design.",
// };
    ...
    <div className="w-full bg-black">
        ...
        <div className="relative flex justify-center items-center text-white md:h-5/6 h-full">
          <div className="gap-6 flex flex-col justify-center items-center text-center">
            ...
            <h1 className="font-pt text-2xl md:text-4xl lg:text-7xl font-medium text-white mb-6">
              Hello, we are{" "}
              <span className="text-blue-500">B2C design Team.</span>
              <span
            ...
            <button className="md:px-8 md:py-2 px-4 py-1 rounded-full outline md:text-base text-sm hover:bg-blue-800 transition-colors duration-200">
              craft a design that converts
            </button>
          </div>
        </div>
      </section>
        ...
        <section className="min-h-screen text-white/85">
          ...
          <div className="flex md:flex-row flex-col gap-10 w-full mt-16 md:p-3 p-5">
            <BorderAnimation className="flex flex-col md:w-1/3 justify-between min-h-[50vh]">
              <FadeSlideIn className="flex flex-col px-8 pt-8">
      ...
      <section className="min-h-screen text-white flex flex-col  justify-between">
        ...
        <div className="flex md:flex-row flex-col  gap-10 md:w-10/12 w-full px-5 md:mx-auto md:my-16 my-6">
          ...
          >
            <BorderAnimation className="flex flex-col justify-between min-h-[25vh] group hover:cursor-pointer">
              <FadeSlideIn className="flex flex-col gap-5 p-6">
        ...
        <section className="flex md:w-10/12 px-5 mx-auto my-16 justify-between">
          <div className="flex flex-col w-full">
            ...
            <div className="flex md:gap-4 gap-2 my-10">
              <Link
                href={"/"}
                className="md:px-8 px-4 md:py-2 py-0 rounded-full w-fit outline-1 outline outline-blue-800 transition-colors duration-300 hover:outline-white flex items-center md:text-base text-xs hover:bg-blue-800"
              >
                Schedule
              </Link>
              <Link
                href="https://www.linkedin.com/company/b2c-inc/"
                target="blank"
                className="md:p-3 p-2 rounded-full w-fit flex items-center outline-1 outline outline-blue-800 transition-colors duration-300 hover:outline-white hover:bg-blue-800"
              >
