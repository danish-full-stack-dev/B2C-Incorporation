...
export default function DesignPage() {
  ...
  const cards = [
    ...
    },
    {
      ...
      title: "ORM Services",
      description:
        "Safeguard and enhance your brand’s image with professional ORM services.",
      outputs: [
    ...
    },
    {
      ...
      description:
        "Build secure, scalable, and innovative blockchain solutions for your business.",
      outputs: [
    ...
    },
    {
      ...
      description:
        "Develop robust and user-friendly trading platforms for seamless financial transactions.",
      outputs: [
        "Real-time trading and market data integration",
    ...
    },
    {
      ...
      title: "AI Automation",
      description:
        "Streamline business processes and boost efficiency with intelligent AI automation solutions.",
      outputs: [
        "Automate repetitive tasks and workflows",
        "AI-powered data analysis and decision-making",
        "Predictive analytics for smarter business strategies",
      ],
    },
  ];
    ...
    <div className="min-h-screen bg-black ">
      ...
      <div className="text-white font-sans mt-[120px] w-10/12 mx-auto">
        ...
        <div className="bg-black max-w-full flex flex-col items-center text-center py-20">
          ...
          <button className="mt-10 hover:bg-blue-800 border w-[200px] px-6 py-3  border-white/30 rounded-full hover:white/80 transition-all duration-200">
            See how we work
          </button>
        </div>
      </div>
